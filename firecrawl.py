...
def format_data(data, fields=None):
    ...
    if fields is None:
        fields = ["Job Title", "Company", "Location", "Summary", "Salary", "Job Type", "Posted Date", "Job URL"]
...
if __name__ == "__main__":
    # Scrape a single URL
    url = 'https://www.indeed.com/jobs?q=data+intern&l=&from=searchOnDesktopSerp&vjk=1a287c960d35d0ef'
